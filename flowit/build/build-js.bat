...
set YUI_BUILD_NAME=app.all

rem ;; where are yuicompressor-ver.jar and bom file
set YUI_FOLDER=E:\Camp\Documents\GitHub\jqfocus\tools\yuicompressor-2.4.7\build
...
set YUI_FILE_LIST=build-js-flist.txt

rem ;; where to put min and debug version of the project
set YUI_FOLDER_DEST=..\js
